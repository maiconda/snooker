...
func TestTokenService_GenerateAndValidateAccessToken(t *testing.T) {
	...
	repo := new(repository.MockRefreshTokenRepository)
...
func TestTokenService_GenerateRefreshToken_Success(t *testing.T) {
	...
	repo.On("Create", mock.Anything, mock.AnythingOfType("*models.RefreshToken")).Return(func(ctx context.Context, rt *models.RefreshToken) *models.RefreshToken {
